...
module Papyrus
  ...
  # method. It may represent a command (i.e. a function), or a variable, or just
  # plain text. In addition, every Node may be tied to a parent Node, since we
  # may need to climb up the node ancestry for information.
  #
  class Node
    extend Forwardable
    ...
    delegate :get => :parent
    delegate [:parser, :document, :template] => :_maybe_parent
